...
int main(int argc, char *argv[])
{
    ...
    printf("Addition >>>\n");
    printf(" - Unsigned addtion: %u\n", unsigned_addition(bv1, bv2));
    printf(" - Sign magnitude addtion: %d\n", sign_magnitude_addition(bv1, bv2));
    printf(" - One's complement addtion: %d\n", ones_complement_addition(bv1, bv2));
    printf(" - Two's complement addtion: %d\n", twos_complement_addition(bv1, bv2));
    return 0;
}
